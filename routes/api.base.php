...
Route::prefix('api')->middleware('api')->group(static function (): void {
    ...
    Route::get('testAPI',[DataController::class, 'responseDATA']);
    Route::get('getAllSong',[DataController::class, 'getAllSongs']);
...
//        Route::get('data', [DataController::class, 'index']);
        ...
        if (YouTube::enabled()) {
            Route::get('pingyou',[YouTubeController::class,'ping']);
